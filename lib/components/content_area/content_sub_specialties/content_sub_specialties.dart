          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: controller.subSpecialties.isEmpty
                    ? Center(
                        child: CustomText(
                    ...
                    : ListView.builder(
                        itemCount: controller
                            .subSpecialties[controller
                                .selectedSpecialtyIndex]['subSpecialties']
                            .length,
                        itemBuilder: (BuildContext context, int index) {
                          // ignore: always_specify_types
                          final subSpecialty =
                              controller.subSpecialties[controller
                                  .selectedSpecialtyIndex]['subSpecialties'][index];
                          return GestureDetector(
                            onTap: () {
                              // change.goToComponentHeader.value = 'Subspecialty';
