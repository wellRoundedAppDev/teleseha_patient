                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              CustomText(
                                text:
                                    '${'next_reservation'.tr} ${controller.checkComming['count'] ?? 0}',
                                fontSize: 12,
                                type: CustomTextType.title,
                                color: const Color(AppColors.colorLineAndText),
                              ),
                          ...
                          Row(
                            children: <Widget>[
                              CustomText(
                                text:
                                    '${'nearest_reservation'.tr} ${controller.nextReservationMinute ?? 0} ${'minutes'.tr}',
                                fontSize: 12,
                                type: CustomTextType.title,
                            ...
                            (int index) {
                              ...
                              return Card(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    width: DEVICE_WIDTH * 0.262,
                                    height: DEVICE_HEIGHT * 0.137,
